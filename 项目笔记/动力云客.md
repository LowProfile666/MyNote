...
![image-20240906095515729](https://gitee.com/LowProfile666/image-bed/raw/master/img/202409060955949.png)
...
前端显示菜单图标时，可以使用componet标签替换el-icon中的内容：
...
一定要配置后端接口 /api 的代理，这个端口就是后端程序运行的端口。
